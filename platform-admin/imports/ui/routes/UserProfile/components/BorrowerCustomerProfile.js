...
const BorrowerCustomerProfile = ({user, idDocs, bankDocs, addressDocs, livePhotoDocument}) => {
  ...
  return (
    <Row className="table-row">
      ...
      <Col xs={12} sm={6} className="col-sep">
        <LABEL>Country</LABEL>
        <P>
          {checkTableValue(country, 'not-provided', (country)=>country.name)}
        </P>
      </Col>
      <Col xs={12}>
...
export default BorrowerCustomerProfile;
