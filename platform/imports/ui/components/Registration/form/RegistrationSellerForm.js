...
const RegistrationSellerForm = ({ handleSubmit, pristine, submitting, openLogin, onAcceptChange, isAccepted }) => (
  <StyledForm className="form" onSubmit={handleSubmit}>
    ...
    <Row className="name-wrapper">
      <Col xs={12} className="text-left name">Name</Col>
      <Col xs={6}>
        <Field
          name="firstName"
          type="text"
    ...
    <Row className="text-center">
      <Col sm={12}>
        <PrimaryButton block type="submit" className="next" disabled={(isAccepted !== 'false')}>
          Register
        </PrimaryButton>
      </Col>
    </Row>
