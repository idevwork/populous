  ...
  renderDatePresets() {
    ...
    return (
      <div style={presetWrapperStyle}>
        <LinkButton size={'12px'} onClick={() => {this.onDatesChange({ startDate: null, endDate: null }); this.setState({focusedInput: null}); }} style={presetButtonStyle}>
          Cancel
        </LinkButton>
        <LinkButton size={'12px'} onClick={() => {this.onDatesChange({ startDate: startDate, endDate: endDate }); this.setState({focusedInput: null}); }} style={presetButtonStyle}>
          Ok
        </LinkButton>
      </div>
    );
