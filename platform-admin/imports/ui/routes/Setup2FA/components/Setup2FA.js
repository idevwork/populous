...
import { H3, Small, Wrap, P } from '../../../components/styled-components/Typography';
        ...
        <Row>
          <Col className="text-center">
            <div className="m-t-50">
              <img src="/images/img-2FA-setup.png" alt="2FA Setup" width={260} />
            </div>
            <H3 className="m-t-30 m-b-50">Please setup 2-factor authentication</H3>
            <P>
            ...
            <ModalBody>
              <Row>
                ...
                <Col sm={3} xs={4} className="text-center">
                  <img src="/images/img-2FA-device.png" className="m-t-30" alt="2FA Setup Device" width={60} />
                </Col>
              </Row>
            </ModalBody>
