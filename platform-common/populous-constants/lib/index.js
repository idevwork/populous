...
const withdrawStatuses = {
  pending: 'pending', // withdraw pending state of Invoice card
  complete: 'complete' // withdraw complete state of Invoice card
}
...
const invoiceSellerFee = 0.0125;
const adminFee = 0.00;
const invoiceRate = 0.0175;

const defaultDailyFee = 0.0583333333
const defaultDailyPenaltyFee = 0.0833333333
const defaultPopulousMonthFee = 0.5
const defaultAdvancedPercentage = 100
const blockchainActionTypes = {
  ...
  usdcToUsdp: 'usdcToUsdp',
  usdpToUsdc: 'usdpToUsdc'
};
...
export {
  ...
  invoiceRate,
  defaultDailyFee,
  defaultDailyPenaltyFee,
  defaultPopulousMonthFee,
  defaultAdvancedPercentage
};
