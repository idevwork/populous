    ...
    return (
      <StyledDiv>
        ...
        <Switch>
          ...
          <Route exact path="/services/terms-and-conditions" render={() => <TermsAndConditions />} />
          <Route exact path="/services/asked-questions" render={() => <AskedQuestions />} />
          <Redirect to="/services/invoice-factoring" />
        </Switch>

        <Footer login={this.openLogin} signup={this.openSignUp} />
