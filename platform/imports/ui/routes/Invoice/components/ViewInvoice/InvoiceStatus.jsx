          ...
          <Col xs="12" md="6" xl="12">
            <StatusCard>
              <CardBody>
                ...
                <LabelText id='discountValue'>{(invoice.fees.dailyFee * 30).toFixed(2)}%</LabelText>
            ...
            { invoice.status === invoiceStatuses.repaymentPending ?
              ...
              <StatusCard>
                <CardBody>
                  ...
                  <P className="m-b-5" slate>Advanced Rate</P>
                  <LabelText>{invoice.fees.advancedPercentage}%</LabelText>
                  <P className="m-b-5" slate>Rate</P>
                  <LabelText>{invoice.fees.dailyFee}% per/day</LabelText>
