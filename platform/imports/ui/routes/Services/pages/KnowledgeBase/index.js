      ...
      <StyledDiv>
        ...
        <div className="main-section">
          ...
          <KnowledgeCard title="Disadvantages of Overdraft facilities">
            <div className="para">Overdrafts can appear to be attractive to businesses, however, there are barriers to accessing overdrafts which cover several of the following factors:</div>
            <ul>
