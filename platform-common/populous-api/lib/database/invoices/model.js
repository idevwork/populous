...
const Fees = Class.create({
  ...
  fields: {
    ...
    dailyPenaltyFee: {
      type: Number,
      default: defaultDailyPenaltyFee
    },
    populousMonthFee: {
      type: Number,
      default: defaultPopulousMonthFee
    },
    advancedPercentage: {
      type: Number,
      default: defaultAdvancedPercentage
    }
  },
});
...
const Invoice = Class.create({
  ...
  helpers: {
    ...
    originalAmount() {
      if (this.fees && this.fees.advancedPercentage) {
        return this.amount * 100 / this.fees.advancedPercentage
      }
      return this.amount
    },
